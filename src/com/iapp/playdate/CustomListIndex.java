...
public class CustomListIndex extends Fragment {

    private static final String TAG = CustomListIndex.class.getSimpleName();

    protected GestureDetector mGestureDetector;

    protected Vector<Model_contactlist> userVector;
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		/*ViewGroup view = (ViewGroup) inflater.inflate(R.layout.sample, container,
				false);*/
		// listView = (ListView) view.findViewById(R.id.booksLV);
...
*/        if (itemPosition < 0) {
     ...
     */
    public void getDisplayListOnChange(LinearLayout sideIndex,ListView listView) 
    {
        ...
        int j = 0;
        for (Model_contactlist user : userVector) {
            strArr[j++] = user.getName().substring(0, 1);
        }
