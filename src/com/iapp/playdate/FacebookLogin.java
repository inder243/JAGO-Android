...
public class FacebookLogin extends AccountAuthenticatorActivity {
	...
	TextView txt_upper,txt_lower;
	Button accept,cancel;
	ImageView img_middle,img;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		relativeLayout = (Button) findViewById(R.id.relative_facebook);
		...
		txt_upper=(TextView)findViewById(R.id.textView1);
		txt_lower=(TextView)findViewById(R.id.link);
		accept=(Button)findViewById(R.id.accept);
		cancel=(Button)findViewById(R.id.cancel);
		txt_lower.setMovementMethod(LinkMovementMethod.getInstance());
		txt_lower.setText(Html.fromHtml(getString(R.string.nice_html)));
		txt_lower.setTypeface(font); 
		txt_upper.setTypeface(font); 
		img_middle=(ImageView)findViewById(R.id.conditions);
		float mReqPercentages1 = 50;
		float mCalculatedWidth1 = (mReqPercentages1 / 100) * height;
		
		img_middle.getLayoutParams().height = (int) (mCalculatedWidth1);
		img_middle.getLayoutParams().width = width;
		...
		mainlayout=(RelativeLayout)findViewById(R.id.relative_facebookMain);
		
		
		/////////////
		
		
		float mReqPercentages = 25;
		...
		float buttonwidth=8;
         float setwidth = (buttonwidth / 100) * height;

		
         relativeLayout.getLayoutParams().height = (int) (setwidth);
		...
		if (isInternetPresent) {
			...
			printKeyHash(FacebookLogin.this);
...
*/
		...
		relativeLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int sdk = android.os.Build.VERSION.SDK_INT;
				 if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
						mainlayout.setBackgroundDrawable( getResources().getDrawable(R.drawable.playdate_official_bg) );
					} else {
						mainlayout.setBackground( getResources().getDrawable(R.drawable.playdate_official_bg));
					}
				
				txt_lower.setVisibility(View.VISIBLE);
				txt_upper.setVisibility(View.VISIBLE);
			...
			/*	Intent it=new Intent(FacebookLogin.this,Terms_And_Conditions.class);
				startActivity(it);
				finish();*/
			...
			public void onClick(View v) {
				...
				try {
					...
					request.setCallback(statusCallback);
					 ...
					 txt_lower.setVisibility(View.GONE);
						txt_upper.setVisibility(View.GONE);
	...
	public void onStart() {
		...
		GoogleAnalytics.getInstance(FacebookLogin.this).reportActivityStart(this);
	...
	public void onStop() {
		...
		try {
		 ...
		 GoogleAnalytics.getInstance(FacebookLogin.this).reportActivityStop(this);
...
try {
	...
	check_response = true;
...

		{
			if (check_response) {
				...
				AlertDialog alertDialog = new AlertDialog.Builder(FacebookLogin.this).create();
	...
	public class Send_registration_id extends
		...
		protected void onPreExecute() {
			...
			url_registration = Constants.REGISTER_DEVICE;//"http://54.191.67.152/playdate/devicetoken.php";
			// url
